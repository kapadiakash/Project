...
# --- Function Based View of scooty_superegories---
# def scooty_superegories(request):
#     return render(request,'core/scooty_superegories.html')

#=========================================================================================================

#--- Class Based View of scooty_superegories ---
class scootysuperegoriesView(View):
    def get(self,request):
        scooty_superegory = Automobile.objects.filter(superegory='scooty')  # we are using filter function of queryset, that will filter those data whose superegory belongs to scooty
        return render(request,'core/scooty_superegories.html',{'scooty_superegory':scooty_superegory})


# --- Function Based View of super_superegories---
# def super_superegories(request):
#     return render(request,'core/super_superegories.html')

#--- Class Based View of super_superegories ---
class supersuperegoriesView(View):
    def get(self,request):
        super_superegory = Automobile.objects.filter(superegory='super')  # we are using filter function of queryset, that will filter those data whose superegory belongs to scooty
        return render(request,'core/super_superegories.html',{'super_superegory':super_superegory})


def bike_superegories(request):
    return render(request,'core/bike_superegories.html')
